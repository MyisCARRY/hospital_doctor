...
import 'package:hospital_doctor/features/auth/presentation/blocs/sign_in_bloc/sign_in_bloc.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [
        AnyAnimatedButtonBlocListener<UserLogin, Token, Failure>(
          bloc: _signInBloc,
  ...
  void _onSignInTap(UserLogin user) {
    if (_formKey.currentState?.validate() ?? false) {
      _signInBloc.add(TriggerAnyAnimatedButtonEvent(user));
    }
  }
}
